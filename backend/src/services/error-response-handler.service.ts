...
class ErrorResponseHandler {
   ...
   */
  private readonly userFriendlyMessages: Record<ErrorCategory, UserFriendlyError> = {
   ...
   */
  private sanitizeDetails(error: Error, context?: ErrorContext): any {
    const details: any = {};
