...
class FollowUpResolver {
   ...
   */
  private parseQuery(query: string, patientId: string): StructuredQuery {
   ...
   * @returns Structured query
   */
  private createNewQuery(query: string, patientId: string): StructuredQuery {
   ...
   */
  private detectIntent(query: string, entities: Entity[]): QueryIntent {
    const lowerQuery = query.toLowerCase();
