...
export interface ExpandedQuery {
  ...
  expanded_terms: string[]; // All expanded query variations
  synonym_map: Record<string, string[]>; // Map of original terms to their synonyms
}
...
class QueryExpander {
   ...
   */
  private readonly MEDICAL_SYNONYMS: Record<string, string[]> = {
   ...
   */
  private replaceEntityInQuery(query: string, entity: string, synonym: string): string {
   ...
   */
  expandBatch(queries: Array<{ query: string; entities: Entity[] }>): ExpandedQuery[] {
