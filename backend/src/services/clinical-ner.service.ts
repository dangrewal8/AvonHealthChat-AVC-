...
} from '../types/clinical-entity.types';
...
class ClinicalNER {
   ...
   */
  private readonly abbreviations: AbbreviationMapping = {
    // Conditions
   ...
   */
  private extractMedications(text: string): PatternMatch[] {
    const matches: PatternMatch[] = [];
   ...
   * @returns Array of pattern matches
   */
  private extractDosages(text: string): PatternMatch[] {
    const matches: PatternMatch[] = [];
   ...
   * @returns Array of pattern matches
   */
  private extractConditions(text: string): PatternMatch[] {
    const matches: PatternMatch[] = [];
   ...
   * @returns Array of pattern matches
   */
  private extractSymptoms(text: string): PatternMatch[] {
    const matches: PatternMatch[] = [];
   ...
   * @returns Array of pattern matches
   */
  private extractProcedures(text: string): PatternMatch[] {
    const matches: PatternMatch[] = [];
   ...
   * @returns Array of pattern matches
   */
  private extractAbbreviations(text: string): PatternMatch[] {
    const matches: PatternMatch[] = [];
