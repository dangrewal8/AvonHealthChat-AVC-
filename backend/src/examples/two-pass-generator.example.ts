 ...
 */
export async function exampleTwoPassGeneration() {
  ...
  try {
    ...
    // Factory service handles Ollama initialization automatically
 ...
 */
export function exampleGetDefaultConfig() {
  console.log('Example 2: Default Configuration');
  console.log('-'.repeat(80));

  const config = twoPassGenerator.getDefaultConfig();
...
export async function exampleCustomConfig() {
  ...
  const customConfig = {
    extraction_model: 'meditron',
    summarization_model: 'meditron',
 ...
 */
export function exampleExplainTwoPass() {
  console.log('Example 4: Explain Two-Pass Approach');
  console.log('-'.repeat(80));

  const explanation = twoPassGenerator.explainTwoPass();
...
export function exampleSummarizationPrompt() {
  ...
  const prompt = twoPassGenerator.getSummarizationSystemPrompt();
 ...
 */
export function exampleValidateResult() {
  ...
  const isValid1 = twoPassGenerator.validateResult(validResult);
  console.log(`    Result: ${isValid1 ? '✅ Valid' : '❌ Invalid'}`);

  console.log('\n  Validating invalid result:\n');
  const isValid2 = twoPassGenerator.validateResult(invalidResult);
 ...
 */
export async function exampleGenerateWithRetries() {
 ...
 */
export function exampleMockExtractionPass() {
 ...
 */
export function exampleMockSummarizationPass() {
 ...
 */
export function exampleTokenUsageAnalysis() {
...
export async function exampleErrorHandling() {
  ...
  try {
    // Ollama factory validates connection automatically
    console.log('       Validates Ollama is running and accessible\n');
  } catch (error) {
...
export async function exampleCompleteWorkflow() {
  ...
  console.log('  Step 3: Initialize Ollama client ✓\n');
