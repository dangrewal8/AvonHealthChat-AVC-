 ...
 */
export async function exampleParallelRequests(patientId: string) {
  const client = createAuthenticatedClient();
 ...
 */
export async function exampleManualTokenManagement() {
  try {
 ...
 */
export async function exampleErrorHandling(patientId: string) {
  const client = createAuthenticatedClient();
 ...
 */
export async function exampleBatchRequests(patientIds: string[]) {
  const client = createAuthenticatedClient();
