 ...
 */
export function exampleMedicationQueries() {
  ...
  queries.forEach((query, i) => {
    ...
    if (result.ambiguousIntents && result.ambiguousIntents.length > 0) {
      ...
      result.ambiguousIntents.forEach((ambiguous) => {
        console.log(
          `      - ${ambiguous.intent} (${(ambiguous.confidence * 100).toFixed(1)}%)`
        );
      });
    }
    console.log('');
 ...
 */
export function exampleCarePlanQueries() {
 ...
 */
export function exampleNotesQueries() {
 ...
 */
export function exampleSummaryQueries() {
 ...
 */
export function exampleComparisonQueries() {
 ...
 */
export function exampleAmbiguousQueries() {
 ...
 */
export function exampleUnknownQueries() {
 ...
 */
export function exampleBatchClassification() {
...
export function exampleConfiguration() {
  ...
  console.log(
    `    Minimum confidence threshold: ${intentClassifier.getConfidenceThreshold()}`
  );
  console.log(`    Ambiguity threshold: ${intentClassifier.getAmbiguityThreshold()}`);
  console.log('');

  console.log('  Explanation:');
  console.log(
    '    - Queries below min confidence threshold default to RETRIEVE_ALL'
  );
  console.log(
    '    - Intents within ambiguity threshold are flagged as ambiguous\n'
  );
 ...
 */
export function exampleMedicalQueries() {
