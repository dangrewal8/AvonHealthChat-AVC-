...
function generateSampleChunks(): Chunk[] {
  return [
    ...
    },
    {
      ...
      patient_id: 'patient_123',
      content:
        'Progress note: Patient continues metformin therapy for diabetes. Compliance good. ' +
    ...
    },
    {
      ...
      patient_id: 'patient_123',
      content:
        'Lab results: A1C 6.8%, fasting glucose 105 mg/dL. Diabetes well-controlled on current regimen. ' +
    ...
    },
    {
      ...
      patient_id: 'patient_123',
      content:
        'Patient education: Discussed diabetes management, medication adherence, and lifestyle modifications. ' +
    ...
    },
    {
      ...
      patient_id: 'patient_123',
      content:
        'Care plan update: Continue metformin 500mg BID for diabetes management. Schedule 3-month follow-up. ' +
    ...
    },
    {
      ...
      patient_id: 'patient_123',
      content:
        'Initial diabetes diagnosis: Type 2 diabetes mellitus. Started on metformin 500mg daily, ' +
    ...
    },
    {
      ...
      patient_id: 'patient_123',
      content:
        'Medication review: Current medications include metformin for diabetes, lisinopril for hypertension. ' +
    ...
    },
    {
      ...
      content:
        'Patient on insulin therapy for type 1 diabetes. Blood glucose control challenging. ' +
 ...
 */
export async function exampleStageMetrics() {
 ...
 */
export async function examplePipelineSummary() {
  ...
  console.log('\n' + integratedRetriever.getPipelineSummary(result));
...
export async function exampleCustomConfiguration() {
  ...
  const result1 = await integratedRetriever.retrieve(query);
  ...
  const result2 = await integratedRetriever.retrieve(query, {
  ...
  const result3 = await integratedRetriever.retrieve(query, {
 ...
 */
export async function exampleCacheBehavior() {
  ...
  // Clear cache first
  integratedRetriever.clearCache();
  ...
  // Cache stats
  const stats = integratedRetriever.getCacheStats();
 ...
 */
export async function exampleDiversification() {
 ...
 */
export async function exampleTimeDecay() {
...
export async function exampleBatchRetrieval() {
  ...
  const results = await integratedRetriever.batchRetrieve(queries);
 ...
 */
export async function exampleHighlights() {
...
export async function exampleWithQueryUnderstanding() {
  ...
  const result = await integratedRetriever.retrieve(structuredQuery);
