...
class SnippetExtractor {
     ...
     */
    extract(text, charOffsets, config = {}) {
        // Merge with defaults
        const cfg = {
            ...DEFAULT_CONFIG,
            ...config,
     ...
     */
    findSentenceBoundary(text, position, direction) {
     ...
     */
    extractMultiple(text, offsetsList, config = {}) {
     ...
     */
    extractWithHighlight(text, charOffsets, config = {}, markers = ['**', '**']) {
        const cfg = {
            ...DEFAULT_CONFIG,
            ...config,
        };
     ...
     */
    getSnippetInfo(text, charOffsets, config = {}) {
        const cfg = {
            ...DEFAULT_CONFIG,
            ...config,
        };
     ...
     */
    validateSnippet(text, charOffsets, config = {}) {
        const snippet = this.extract(text, charOffsets, config);
...
exports.default = snippetExtractor;
//# sourceMappingURL=snippet-extractor.service.js.map