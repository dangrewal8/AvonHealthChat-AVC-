...
(function (ErrorCode) {
    ...
    ErrorCode["NO_RESULTS_FOUND"] = "NO_RESULTS_FOUND";
    // Query & Processing
    ErrorCode["INVALID_QUERY"] = "INVALID_QUERY";
    ErrorCode["QUERY_TOO_BROAD"] = "QUERY_TOO_BROAD";
    ErrorCode["QUERY_TOO_SPECIFIC"] = "QUERY_TOO_SPECIFIC";
    ErrorCode["EMPTY_QUERY"] = "EMPTY_QUERY";
    // Retrieval
    ErrorCode["RETRIEVAL_FAILED"] = "RETRIEVAL_FAILED";
    ErrorCode["VECTOR_DB_ERROR"] = "VECTOR_DB_ERROR";
    ErrorCode["LOW_RELEVANCE"] = "LOW_RELEVANCE";
    // Answer Generation
    ErrorCode["GENERATION_FAILED"] = "GENERATION_FAILED";
    ErrorCode["EXTRACTION_FAILED"] = "EXTRACTION_FAILED";
    ErrorCode["LLM_ERROR"] = "LLM_ERROR";
    ErrorCode["LLM_QUOTA_EXCEEDED"] = "LLM_QUOTA_EXCEEDED";
    // Validation
    ErrorCode["VALIDATION_FAILED"] = "VALIDATION_FAILED";
    ErrorCode["CITATION_VALIDATION_FAILED"] = "CITATION_VALIDATION_FAILED";
    ErrorCode["CONFIDENCE_TOO_LOW"] = "CONFIDENCE_TOO_LOW";
...
const ERROR_TEMPLATES = {
    ...
    [ErrorCode.AUTH_FAILED]: {
        ...
        recoverySuggestion: 'Please try again in a few moments. If the issue persists, contact support.',
    ...
    [ErrorCode.CONFIDENCE_TOO_LOW]: {
        ...
        recoverySuggestion: 'Try asking a more specific question or consult a healthcare professional.',
        category: 'confidence',
    },
    // Rate Limiting & Performance
...
class ErrorCatalog {
     ...
     */
    getErrorCodesByStatus(httpStatus) {
        return this.getAllErrorCodes().filter(code => {
            const template = this.getTemplate(code);
