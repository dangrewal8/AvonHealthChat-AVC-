...
exports.ClinicalEntityType = void 0;
/**
 * Clinical entity types to extract
 */
var ClinicalEntityType;
(function (ClinicalEntityType) {
    ClinicalEntityType["MEDICATION"] = "medication";
    ClinicalEntityType["DIAGNOSIS"] = "diagnosis";
    ClinicalEntityType["PROCEDURE"] = "procedure";
    ClinicalEntityType["LAB_RESULT"] = "lab_result";
    ClinicalEntityType["VITAL_SIGN"] = "vital_sign";
    ClinicalEntityType["ALLERGY"] = "allergy";
    ClinicalEntityType["SYMPTOM"] = "symptom";
})(ClinicalEntityType || (exports.ClinicalEntityType = ClinicalEntityType = {}));
/**
 * Medical Prompt Templates Service
 */
class MedicalPromptTemplatesService {
    ...
    DEFAULT_DISCLAIMER = {
        enabled: true,
        shortForm: 'This information is for educational purposes only and does not constitute medical advice.',
        longForm: '⚠️ MEDICAL DISCLAIMER: This information is generated by an AI system and is for ' +
     ...
     * );
     */
    medicalQA(question, context, options = {}) {
        const { includeDisclaimer = true, requireCitations = true, requireConfidenceLevel = true, } = options;
...
ANSWER:${disclaimerText}`;
     ...
     * );
     */
    extractClinicalEntities(text, entityTypes = Object.values(ClinicalEntityType), _options = {}) {
...
EXTRACTED ENTITIES (JSON):`;
     ...
     * );
     */
    summarizeMedicalRecord(record, format = 'soap', _options = {}) {
...
SUMMARY:`;
     ...
     * );
     */
    analyzeTreatmentPlan(plan, components = {}, _options = {}) {
        const { medications = true, procedures = true, followUp = true, patientEducation = true, labOrders = true, } = components;
        const systemPrompt = this.buildSystemPrompt('treatment_analysis');
        const analysisComponents = [];
        if (medications)
            analysisComponents.push('- Medications: doses, frequencies, interactions');
        if (procedures)
            analysisComponents.push('- Procedures: indications, risks, alternatives');
        if (followUp)
            analysisComponents.push('- Follow-up: timeline, monitoring parameters');
        if (patientEducation)
            analysisComponents.push('- Patient education: lifestyle, warning signs');
        if (labOrders)
            analysisComponents.push('- Lab orders: baseline tests, monitoring labs');
        return `${systemPrompt}
...
ANALYSIS:`;
     ...
     * );
     */
    differentialDiagnosis(presentation, maxDiagnoses = 5, _options = {}) {
...
DIFFERENTIAL DIAGNOSIS:`;
     ...
     * );
     */
    medicationReconciliation(currentMeds, reportedMeds, _options = {}) {
...
MEDICATION RECONCILIATION:`;
     ...
     * );
     */
    labResultInterpretation(labResults, clinicalContext = '', _options = {}) {
...
INTERPRETATION:`;
    ...
    buildSystemPrompt(taskType) {
        ...
        const taskSpecificPrompts = {
            ...
            differential_diagnosis: basePrompt +
            ...
            medication_reconciliation: basePrompt +
     ...
     */
    buildEntityExtractionSchema(entityTypes) {
        const schemas = {
...
${selectedSchemas.join(',\n')}
     ...
     */
    getSummaryFormatInstructions(format) {
        const instructions = {
            soap: `SOAP FORMAT:
...
Provide comprehensive summary with all relevant clinical details.`,
     ...
     */
    getMedicalDisclaimer(format = 'long') {
        return format === 'short'
     ...
     */
    appendDisclaimer(response, format = 'long') {
...
exports.default = medicalPromptTemplates;
//# sourceMappingURL=medical-prompt-templates.service.js.map