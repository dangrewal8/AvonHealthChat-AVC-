...
class DateFormatter {
     ...
     */
    formatRelative(isoDate, referenceDate = new Date()) {
     ...
     */
    formatAbsolute(isoDate, format = 'long') {
        const date = new Date(isoDate);
     ...
     */
    formatDateTime(isoDate, format = 'long') {
        const date = new Date(isoDate);
     ...
     */
    formatDateRange(startDate, endDate, format = 'long') {
     ...
     */
    isToday(isoDate, referenceDate = new Date()) {
        const date = new Date(isoDate);
     ...
     */
    isYesterday(isoDate, referenceDate = new Date()) {
        const date = new Date(isoDate);
     ...
     * @returns Relative time string
     */
    getTimeAgo(isoDate, referenceDate = new Date()) {
        const date = new Date(isoDate);
        const diffMs = referenceDate.getTime() - date.getTime();
        return this.getRelativeTimeString(diffMs);
    }
