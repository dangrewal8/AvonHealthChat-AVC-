...
exports.exampleGenerateLinks = exampleGenerateLinks;
exports.exampleBuildDeepLink = exampleBuildDeepLink;
exports.exampleInlineReferences = exampleInlineReferences;
exports.exampleBibliography = exampleBibliography;
exports.exampleGroupByArtifact = exampleGroupByArtifact;
exports.exampleGroupedBibliography = exampleGroupedBibliography;
exports.exampleHTML = exampleHTML;
exports.exampleMarkdown = exampleMarkdown;
exports.exampleValidateURL = exampleValidateURL;
exports.exampleUniqueArtifacts = exampleUniqueArtifacts;
exports.exampleFilterByType = exampleFilterByType;
exports.exampleSortByDate = exampleSortByDate;
exports.exampleAnswerWithCitations = exampleAnswerWithCitations;
exports.exampleHighlighting = exampleHighlighting;
exports.exampleBaseURL = exampleBaseURL;
exports.exampleExplain = exampleExplain;
exports.runAllExamples = runAllExamples;
const citation_link_generator_service_1 = __importDefault(require("../services/citation-link-generator.service"));
/**
 ...
 */
function exampleGenerateLinks() {
    console.log('Example 1: Generate Citation Links');
    console.log('-'.repeat(80));
    const provenance = generateSampleProvenance();
    const links = citation_link_generator_service_1.default.generateLinks(provenance);
 ...
 */
function exampleBuildDeepLink() {
    console.log('Example 2: Build Deep Links');
    console.log('-'.repeat(80));
    console.log('  Deep links with text highlighting:\n');
    const link1 = citation_link_generator_service_1.default.buildDeepLink('note_123', [18, 47], 'clinical_note');
    console.log(`    Clinical note: ${link1}`);
    const link2 = citation_link_generator_service_1.default.buildDeepLink('plan_456', [0, 62], 'care_plan');
    console.log(`    Care plan: ${link2}`);
    const link3 = citation_link_generator_service_1.default.buildDeepLink('lab_789', [0, 25], 'lab_result');
    console.log(`    Lab result: ${link3}`);
    const link4 = citation_link_generator_service_1.default.buildDeepLink('med_101', [10, 30], 'medication');
 ...
 */
function exampleInlineReferences() {
    console.log('Example 3: Format Inline References');
    console.log('-'.repeat(80));
    const provenance = generateSampleProvenance();
    const links = citation_link_generator_service_1.default.generateLinks(provenance);
    const inline = citation_link_generator_service_1.default.formatInlineReferences(links);
...
function exampleBibliography() {
    ...
    const provenance = generateSampleProvenance();
    const links = citation_link_generator_service_1.default.generateLinks(provenance);
    const bibliography = citation_link_generator_service_1.default.formatBibliography(links);
...
function exampleGroupByArtifact() {
    ...
    const provenance = generateSampleProvenance();
    const links = citation_link_generator_service_1.default.generateLinks(provenance);
    const grouped = citation_link_generator_service_1.default.groupByArtifact(links);
 ...
 */
function exampleGroupedBibliography() {
    console.log('Example 6: Format Grouped Bibliography');
    console.log('-'.repeat(80));
    const provenance = generateSampleProvenance();
    const links = citation_link_generator_service_1.default.generateLinks(provenance);
    const grouped = citation_link_generator_service_1.default.groupByArtifact(links);
    const bibliography = citation_link_generator_service_1.default.formatGroupedBibliography(grouped);
...
function exampleHTML() {
    ...
    const links = citation_link_generator_service_1.default.generateLinks(provenance);
    const html = citation_link_generator_service_1.default.generateHTML(links);
...
function exampleMarkdown() {
    ...
    const provenance = generateSampleProvenance().slice(0, 2);
    const links = citation_link_generator_service_1.default.generateLinks(provenance);
    const markdown = citation_link_generator_service_1.default.generateMarkdown(links);
...
function exampleValidateURL() {
    ...
    urls.forEach(url => {
        const valid = citation_link_generator_service_1.default.validateURL(url);
 ...
 */
function exampleUniqueArtifacts() {
    console.log('Example 10: Get Unique Artifacts Count');
    console.log('-'.repeat(80));
    const provenance = generateSampleProvenance();
    const links = citation_link_generator_service_1.default.generateLinks(provenance);
    const uniqueCount = citation_link_generator_service_1.default.getUniqueArtifactsCount(links);
...
function exampleFilterByType() {
    ...
    types.forEach(type => {
        const filtered = citation_link_generator_service_1.default.getCitationsByType(links, type);
...
function exampleSortByDate() {
    ...
    const sorted = citation_link_generator_service_1.default.sortByDate(links, false);
    sorted.forEach(link => {
        console.log(`    ${link.display_text} ${link.note_date} - ${link.artifact_id}`);
    });
    console.log('');
    console.log('  Citations sorted by date (oldest first):\n');
    const sortedAsc = citation_link_generator_service_1.default.sortByDate(links, true);
 ...
 */
function exampleAnswerWithCitations() {
 ...
 */
function exampleHighlighting() {
    console.log('Example 14: Highlighting Enabled/Disabled');
    console.log('-'.repeat(80));
    console.log('  Current highlighting status:');
    console.log(`    Enabled: ${citation_link_generator_service_1.default.isHighlightingEnabled()}\n`);
    console.log('  Link with highlighting disabled:');
    citation_link_generator_service_1.default.setHighlightingEnabled(false);
    const link1 = citation_link_generator_service_1.default.buildDeepLink('note_123', [18, 47], 'clinical_note');
    console.log(`    ${link1}\n`);
    console.log('  Link with highlighting enabled:');
    citation_link_generator_service_1.default.setHighlightingEnabled(true);
    const link2 = citation_link_generator_service_1.default.buildDeepLink('note_123', [18, 47], 'clinical_note');
    console.log(`    ${link2}\n`);
    // Reset to default
    citation_link_generator_service_1.default.setHighlightingEnabled(false);
    console.log('  ✅ Success\n');
 ...
 */
function exampleBaseURL() {
    console.log('Example 15: Base URL Configuration');
    console.log('-'.repeat(80));
    const baseURL = citation_link_generator_service_1.default.getBaseURL();
    console.log('  Base URL configuration:\n');
    console.log(`    Base URL: ${baseURL}`);
    console.log(`    Highlighting: ${citation_link_generator_service_1.default.isHighlightingEnabled()}\n`);
    console.log('  Example URLs for different artifact types:\n');
    const types = ['clinical_note', 'care_plan', 'medication', 'lab_result', 'imaging'];
    types.forEach(type => {
        const link = citation_link_generator_service_1.default.buildDeepLink('artifact_123', [0, 10], type);
...
function exampleExplain() {
    ...
    console.log('-'.repeat(80));
    const explanation = citation_link_generator_service_1.default.explain();
    console.log('\n' + explanation.split('\n').map(line => `  ${line}`).join('\n'));
    console.log('\n  ✅ Success\n');
}
/**
...
// runAllExamples();
//# sourceMappingURL=citation-link-generator.example.js.map