...
exports.exampleHighConfidence = exampleHighConfidence;
exports.exampleMediumConfidence = exampleMediumConfidence;
exports.exampleLowConfidence = exampleLowConfidence;
exports.exampleAssessExtractionQuality = exampleAssessExtractionQuality;
exports.exampleCalculateSupportDensity = exampleCalculateSupportDensity;
exports.exampleGetConfidenceLabel = exampleGetConfidenceLabel;
exports.exampleGetConfidenceBreakdown = exampleGetConfidenceBreakdown;
exports.exampleIsAcceptable = exampleIsAcceptable;
exports.exampleGetRecommendation = exampleGetRecommendation;
exports.exampleExplainFormula = exampleExplainFormula;
exports.exampleGetWeights = exampleGetWeights;
exports.exampleEdgeCases = exampleEdgeCases;
exports.runAllExamples = runAllExamples;
const confidence_scorer_service_1 = __importDefault(require("../services/confidence-scorer.service"));
/**
 * Generate high-quality retrieval result
 */
function generateHighQualityRetrieval() {
    const chunks = [
        {
            chunk_id: 'chunk_001',
 ...
 */
function generateMediumQualityRetrieval() {
    const chunks = [
        {
            chunk_id: 'chunk_001',
            artifact_id: 'note_123',
 ...
 */
function generateLowQualityRetrieval() {
    const chunks = [
        {
            chunk_id: 'chunk_001',
            artifact_id: 'note_123',
 ...
 */
function generateHighQualityExtractions() {
    return [
        {
 ...
 */
function generateMediumQualityExtractions() {
    return [
        {
            type: 'general_note',
 ...
 */
function generateLowQualityExtractions() {
    return [
        {
            type: 'general_note',
 ...
 */
function exampleHighConfidence() {
    ...
    const confidence = confidence_scorer_service_1.default.calculateConfidence(retrieval, extractions);
 ...
 */
function exampleMediumConfidence() {
 ...
 */
function exampleAssessExtractionQuality() {
    ...
    const highScore = confidence_scorer_service_1.default.assessExtractionQuality(highQuality);
    ...
    const mediumScore = confidence_scorer_service_1.default.assessExtractionQuality(mediumQuality);
    ...
    const lowScore = confidence_scorer_service_1.default.assessExtractionQuality(lowQuality);
    console.log(`    Low Quality (no provenance): ${lowScore.toFixed(3)}`);
    // No extractions
    const noExtractions = [];
    const noScore = confidence_scorer_service_1.default.assessExtractionQuality(noExtractions);
 ...
 */
function exampleCalculateSupportDensity() {
    console.log('Example 5: Calculate Support Density');
    console.log('-'.repeat(80));
    const retrieval = generateHighQualityRetrieval();
    const extractions = generateHighQualityExtractions();
    console.log('  Testing support density calculation:\n');
    const density = confidence_scorer_service_1.default.calculateSupportDensity(extractions, retrieval.candidates);
 ...
 */
function exampleGetConfidenceLabel() {
    console.log('Example 6: Get Confidence Label');
    console.log('-'.repeat(80));
    console.log('  Testing confidence labeling:\n');
    console.log(`    Score 0.85: ${confidence_scorer_service_1.default.getConfidenceLabel(0.85)}`);
    console.log(`    Score 0.70: ${confidence_scorer_service_1.default.getConfidenceLabel(0.70)}`);
    console.log(`    Score 0.55: ${confidence_scorer_service_1.default.getConfidenceLabel(0.55)}`);
    console.log(`    Score 0.40: ${confidence_scorer_service_1.default.getConfidenceLabel(0.40)}`);
    console.log(`    Score 0.25: ${confidence_scorer_service_1.default.getConfidenceLabel(0.25)}\n`);
    console.log('  Thresholds:');
    const thresholds = confidence_scorer_service_1.default.getThresholds();
 ...
 */
function exampleGetConfidenceBreakdown() {
    console.log('Example 7: Get Confidence Breakdown');
    console.log('-'.repeat(80));
    const retrieval = generateHighQualityRetrieval();
    const extractions = generateHighQualityExtractions();
    console.log('  Detailed confidence breakdown:\n');
    const breakdown = confidence_scorer_service_1.default.getConfidenceBreakdown(retrieval, extractions);
...
function exampleIsAcceptable() {
    ...
    const highConfidence = confidence_scorer_service_1.default.calculateConfidence(highRetrieval, highExtractions);
    console.log(`    High Confidence (${highConfidence.score.toFixed(3)}): ${confidence_scorer_service_1.default.isAcceptable(highConfidence) ? '✅ Acceptable' : '❌ Not Acceptable'}`);
    const mediumRetrieval = generateMediumQualityRetrieval();
    const mediumExtractions = generateMediumQualityExtractions();
    const mediumConfidence = confidence_scorer_service_1.default.calculateConfidence(mediumRetrieval, mediumExtractions);
    console.log(`    Medium Confidence (${mediumConfidence.score.toFixed(3)}): ${confidence_scorer_service_1.default.isAcceptable(mediumConfidence) ? '✅ Acceptable' : '❌ Not Acceptable'}`);
    const lowRetrieval = generateLowQualityRetrieval();
    const lowExtractions = generateLowQualityExtractions();
    const lowConfidence = confidence_scorer_service_1.default.calculateConfidence(lowRetrieval, lowExtractions);
    console.log(`    Low Confidence (${lowConfidence.score.toFixed(3)}): ${confidence_scorer_service_1.default.isAcceptable(lowConfidence) ? '✅ Acceptable' : '❌ Not Acceptable'}\n`);
    console.log('  ✅ Success\n');
}
/**
 * Example 9: Get recommendation
 */
function exampleGetRecommendation() {
    ...
    console.log(`      ${confidence_scorer_service_1.default.getRecommendation(highConfidence)}\n`);
    const mediumRetrieval = generateMediumQualityRetrieval();
    const mediumExtractions = generateMediumQualityExtractions();
    const mediumConfidence = confidence_scorer_service_1.default.calculateConfidence(mediumRetrieval, mediumExtractions);
    console.log(`    Medium Confidence:`);
    console.log(`      ${confidence_scorer_service_1.default.getRecommendation(mediumConfidence)}\n`);
    const lowRetrieval = generateLowQualityRetrieval();
    const lowExtractions = generateLowQualityExtractions();
    const lowConfidence = confidence_scorer_service_1.default.calculateConfidence(lowRetrieval, lowExtractions);
    console.log(`    Low Confidence:`);
    console.log(`      ${confidence_scorer_service_1.default.getRecommendation(lowConfidence)}\n`);
    console.log('  ✅ Success\n');
}
/**
 * Example 10: Explain formula
 */
function exampleExplainFormula() {
    console.log('Example 10: Explain Formula');
    console.log('-'.repeat(80));
    const explanation = confidence_scorer_service_1.default.explainFormula();
    console.log('\n' + explanation.split('\n').map(line => `  ${line}`).join('\n'));
    console.log('\n  ✅ Success\n');
}
/**
 ...
 */
function exampleGetWeights() {
    console.log('Example 11: Get Weights');
    console.log('-'.repeat(80));
    const weights = confidence_scorer_service_1.default.getWeights();
...
function exampleEdgeCases() {
    ...
    const noExtractions = [];
    const noDataConfidence = confidence_scorer_service_1.default.calculateConfidence(noCandidates, noExtractions);
    ...
    const highRetrieval = generateHighQualityRetrieval();
    const noExtractionsConfidence = confidence_scorer_service_1.default.calculateConfidence(highRetrieval, []);
    ...
    const lowRetrieval = generateLowQualityRetrieval();
    const highExtractions = generateHighQualityExtractions();
    const mixedConfidence = confidence_scorer_service_1.default.calculateConfidence(lowRetrieval, highExtractions);
...
// runAllExamples();
//# sourceMappingURL=confidence-scorer.example.js.map