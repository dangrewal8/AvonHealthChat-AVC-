...
exports.exampleBasicParsing = exampleBasicParsing;
exports.exampleIntentFiltering = exampleIntentFiltering;
exports.exampleTemporalFiltering = exampleTemporalFiltering;
exports.exampleEntityExtraction = exampleEntityExtraction;
exports.exampleCompleteParsingWithMetadata = exampleCompleteParsingWithMetadata;
exports.exampleIntentSpecificExtraction = exampleIntentSpecificExtraction;
exports.exampleContextValidation = exampleContextValidation;
exports.exampleBatchProcessing = exampleBatchProcessing;
exports.exampleQuerySanitization = exampleQuerySanitization;
exports.exampleFilterConstruction = exampleFilterConstruction;
exports.exampleErrorHandling = exampleErrorHandling;
exports.exampleRealWorldQueries = exampleRealWorldQueries;
...
function exampleBasicParsing() {
    ...
    queries.forEach((query, i) => {
        ...
        const structured = query_understanding_agent_service_1.default.parse(query, PATIENT_ID);
 ...
 */
function exampleIntentFiltering() {
 ...
 */
function exampleTemporalFiltering() {
 ...
 */
function exampleCompleteParsingWithMetadata() {
    ...
    const result = query_understanding_agent_service_1.default.parseWithMetadata(query, PATIENT_ID);
 ...
 */
function exampleIntentSpecificExtraction() {
    ...
    queries.forEach((query, i) => {
        ...
        switch (structured.intent) {
            case intent_classifier_service_1.QueryIntent.RETRIEVE_MEDICATIONS:
                const medications = query_understanding_agent_service_1.default.getMedications(structured);
                console.log(`    Medications: ${medications.map((m) => m.text).join(', ') || 'None'}`);
                break;
            case intent_classifier_service_1.QueryIntent.RETRIEVE_CARE_PLANS:
                const conditions = query_understanding_agent_service_1.default.getConditions(structured);
                console.log(`    Conditions: ${conditions.map((c) => c.text).join(', ') || 'None'}`);
                break;
            case intent_classifier_service_1.QueryIntent.RETRIEVE_NOTES:
                const symptoms = query_understanding_agent_service_1.default.getSymptoms(structured);
 ...
 */
function exampleContextValidation() {
    ...
    queries.forEach((query, i) => {
        console.log(`  Query ${i + 1}: "${query}"`);
        const structured = query_understanding_agent_service_1.default.parse(query, PATIENT_ID);
        const hasSufficientContext = query_understanding_agent_service_1.default.hasSufficientContext(structured);
        console.log(`    Intent: ${structured.intent}`);
        console.log(`    Entities: ${structured.entities.length}`);
...
function exampleBatchProcessing() {
    ...
    const results = query_understanding_agent_service_1.default.parseBatch(queries);
    results.forEach((structured, i) => {
        console.log(`  Result ${i + 1}:`);
        console.log(`    Patient: ${structured.patient_id}`);
        console.log(`    Intent: ${structured.intent}`);
        console.log(`    Summary: ${query_understanding_agent_service_1.default.getSummary(structured)}`);
        console.log('');
    });
    console.log('  ✅ Success\n');
}
 ...
 */
function exampleQuerySanitization() {
    ...
    queries.forEach((query, i) => {
        ...
        const sanitized = query_understanding_agent_service_1.default.sanitizeQuery(query);
 ...
 */
function exampleFilterConstruction() {
...
function exampleErrorHandling() {
    ...
    testCases.forEach(({ query, patientId, expectedError }, i) => {
        ...
        try {
            query_understanding_agent_service_1.default.parse(query, patientId);
 ...
 */
function exampleRealWorldQueries() {
    ...
    queries.forEach((query, i) => {
        ...
        console.log(`    Summary: ${query_understanding_agent_service_1.default.getSummary(result)}`);
        console.log('');
    });
    console.log('  ✅ Success\n');
}
...
// runAllExamples();
//# sourceMappingURL=query-understanding-agent.example.js.map