...
exports.example1_BasicGeneration = example1_BasicGeneration;
exports.example2_SpecificTypes = example2_SpecificTypes;
exports.example3_EdgeCases = example3_EdgeCases;
exports.example4_ReproducibleGeneration = example4_ReproducibleGeneration;
exports.example5_GoldenDataset = example5_GoldenDataset;
exports.example6_ExportToJSON = example6_ExportToJSON;
exports.example7_LargeDataset = example7_LargeDataset;
exports.example8_MultiplePatients = example8_MultiplePatients;
...
function example1_BasicGeneration() {
    ...
    const generator = (0, test_data_generator_1.createTestDataGenerator)({ seed: 12345 });
...
function example2_SpecificTypes() {
    ...
    const generator = (0, test_data_generator_1.createTestDataGenerator)({ seed: 67890 });
    // Generate care plan
...
function example3_EdgeCases() {
    ...
    const generator = (0, test_data_generator_1.createTestDataGenerator)({ seed: 11111 });
...
function example4_ReproducibleGeneration() {
    ...
    const seed = 99999;
    // First generation
    const generator1 = (0, test_data_generator_1.createTestDataGenerator)({ seed });
    const artifacts1 = generator1.generateArtifacts(5, 'patient-001', false);
    // Second generation with same seed
    const generator2 = (0, test_data_generator_1.createTestDataGenerator)({ seed });
    ...
    for (let i = 0; i < artifacts1.length; i++) {
        if (artifacts1[i].type !== artifacts2[i].type ||
...
function example5_GoldenDataset() {
    ...
    const generator = (0, test_data_generator_1.createTestDataGenerator)();
...
function example6_ExportToJSON() {
    console.log('\n=== Example 6: Export to JSON ===\n');
    const generator = (0, test_data_generator_1.createTestDataGenerator)({ seed: 54321 });
...
function example7_LargeDataset() {
    console.log('\n=== Example 7: Large Dataset Generation ===\n');
    const generator = (0, test_data_generator_1.createTestDataGenerator)({ seed: 99999 });
...
function example8_MultiplePatients() {
    console.log('\n=== Example 8: Multiple Patients ===\n');
    const generator = (0, test_data_generator_1.createTestDataGenerator)({ seed: 77777 });
    const patients = [
        'patient-001',
        'patient-002',
        'patient-003',
...
//# sourceMappingURL=test-data-generator.example.js.map