...
exports.exampleSingleEmbedding = exampleSingleEmbedding;
exports.exampleCaching = exampleCaching;
exports.exampleBatchEmbeddings = exampleBatchEmbeddings;
exports.exampleLargeBatch = exampleLargeBatch;
exports.exampleEmptyText = exampleEmptyText;
exports.exampleMixedBatch = exampleMixedBatch;
exports.exampleCacheStats = exampleCacheStats;
exports.exampleClearCache = exampleClearCache;
...
async function exampleSingleEmbedding() {
    ...
    try {
        ...
        const embedding = await embedding_factory_service_1.default.generateEmbedding(text);
...
async function exampleCaching() {
    ...
    try {
        ...
        const embedding1 = await embedding_factory_service_1.default.generateEmbedding(text);
        const duration1 = Date.now() - start1;
        console.log('    Duration:', `${duration1}ms`);
        // Second call (cache hit)
        console.log('  Second call (should be cache hit):');
        const start2 = Date.now();
        const embedding2 = await embedding_factory_service_1.default.generateEmbedding(text);
 ...
 */
async function exampleEmptyText() {
    console.log('Example 5: Empty Text Handling');
    console.log('-'.repeat(80));
    try {
        await embedding_factory_service_1.default.generateEmbedding('');
 ...
 */
async function exampleMixedBatch() {
...
async function exampleCacheStats() {
    ...
    await embedding_factory_service_1.default.generateBatchEmbeddings(texts);
    // Get cache stats
    const stats = embedding_factory_service_1.default.getCacheStats();
...
async function exampleClearCache() {
    ...
    console.log('-'.repeat(80));
    // Generate embeddings
    await embedding_factory_service_1.default.generateEmbedding('Test text for caching');
    console.log('  Before clear:', embedding_factory_service_1.default.getCacheStats().size, 'entries');
    // Clear cache
    embedding_factory_service_1.default.clearCache();
    console.log('  After clear:', embedding_factory_service_1.default.getCacheStats().size, 'entries');
    console.log('  ✅ Success\n');
}
/**
...
async function exampleConfiguration() {
    ...
    console.log('-'.repeat(80));
    const config = embedding_factory_service_1.default.getConfig();
...
// runAllExamples();
//# sourceMappingURL=embedding.example.js.map