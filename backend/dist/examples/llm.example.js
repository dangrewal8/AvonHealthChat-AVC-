...
exports.exampleConfigure = exampleConfigure;
exports.exampleExtract = exampleExtract;
exports.exampleSummarize = exampleSummarize;
exports.exampleExtractWithRetries = exampleExtractWithRetries;
exports.exampleTokenUsage = exampleTokenUsage;
exports.exampleErrorHandling = exampleErrorHandling;
exports.exampleTemperatureComparison = exampleTemperatureComparison;
exports.exampleCheckConfiguration = exampleCheckConfiguration;
exports.exampleCustomConfiguration = exampleCustomConfiguration;
exports.exampleCompleteWorkflow = exampleCompleteWorkflow;
exports.exampleRetryBehavior = exampleRetryBehavior;
exports.examplePerformanceMonitoring = examplePerformanceMonitoring;
exports.runAllExamples = runAllExamples;
const llm_factory_service_1 = __importDefault(require("../services/llm-factory.service"));
/**
 * Example 1: Configure LLM service
 */
function exampleConfigure() {
    console.log('Example 1: Configure LLM Service');
    console.log('-'.repeat(80));
    try {
        llm_factory_service_1.default.configure({
            model: 'gpt-4',
        ...
        console.log('  Current config:', llm_factory_service_1.default.getConfig());
    }
    catch (error) {
 ...
 */
async function exampleExtractWithRetries() {
...
async function exampleTokenUsage() {
    ...
    llm_factory_service_1.default.resetTokenUsage();
    console.log('  Initial token usage:');
    let usage = llm_factory_service_1.default.getTokenUsage();
    ...
    usage = llm_factory_service_1.default.getTokenUsage();
...
async function exampleErrorHandling() {
    ...
    try {
        llm_factory_service_1.default.configure({ apiKey: '' });
    }
    catch (error) {
 ...
 */
function exampleTemperatureComparison() {
...
function exampleCheckConfiguration() {
    ...
    console.log('-'.repeat(80));
    console.log('  Is Configured:', llm_factory_service_1.default.isConfigured());
    console.log('  Current Config:', llm_factory_service_1.default.getConfig());
    console.log('  Extraction Prompt:', llm_factory_service_1.default.getExtractionSystemPrompt().substring(0, 50) + '...');
    console.log('  Summarization Prompt:', llm_factory_service_1.default.getSummarizationSystemPrompt().substring(0, 50) + '...');
    console.log('\n  ✅ Success\n');
}
/**
...
async function exampleCompleteWorkflow() {
    ...
    const usage = llm_factory_service_1.default.getTokenUsage();
    console.log(`    Total Tokens: ${usage.totalTokens}`);
    console.log(`    Requests: ${usage.requestCount}\n`);
    console.log('  Step 6: Return results ✓\n');
    console.log('  ⚠️  Full workflow requires OPENAI_API_KEY\n');
    console.log('  ✅ Complete Workflow Success\n');
}
/**
 * Example 11: Retry behavior demonstration
 */
async function exampleRetryBehavior() {
...
// runAllExamples();
//# sourceMappingURL=llm.example.js.map