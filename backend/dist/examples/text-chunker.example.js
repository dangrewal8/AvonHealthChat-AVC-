...
exports.example1_basicChunking = example1_basicChunking;
exports.example2_shortArtifact = example2_shortArtifact;
exports.example3_longArtifact = example3_longArtifact;
exports.example4_chunkOverlap = example4_chunkOverlap;
exports.example5_charOffsetTracking = example5_charOffsetTracking;
exports.example6_sentenceSplitting = example6_sentenceSplitting;
exports.example7_edgeCaseEmptyText = example7_edgeCaseEmptyText;
exports.example8_edgeCaseVeryLongSentence = example8_edgeCaseVeryLongSentence;
exports.example9_chunkStatistics = example9_chunkStatistics;
exports.example10_offsetVerification = example10_offsetVerification;
exports.example11_realWorldMedicalNote = example11_realWorldMedicalNote;
exports.example12_artifactTypeIntegration = example12_artifactTypeIntegration;
exports.example13_metadataPreservation = example13_metadataPreservation;
exports.example14_multipleChunksOverlap = example14_multipleChunksOverlap;
exports.example15_explainTextChunker = example15_explainTextChunker;
const text_chunker_service_1 = __importDefault(require("../services/text-chunker.service"));
/**
 * Example 1: Basic Chunking
 *
 * Chunk a document into overlapping segments
 */
function example1_basicChunking() {
    console.log('\n=== Example 1: Basic Chunking ===\n');
...
Follow-up in 1 week if symptoms persist.`,
    ...
    // Chunk the artifact
    const chunks = text_chunker_service_1.default.chunk(artifact);
 ...
 */
function example2_shortArtifact() {
    console.log('\n=== Example 2: Short Artifact (Single Chunk) ===\n');
    const artifact = {
        id: 'artifact_002',
        type: 'medication',
 ...
 */
function example3_longArtifact() {
    console.log('\n=== Example 3: Long Artifact (Multiple Chunks) ===\n');
 ...
 */
function example4_chunkOverlap() {
    console.log('\n=== Example 4: Chunk Overlap Verification ===\n');
    // Create artifact with multiple chunks
    const longText = Array(60)
        .fill('This is a sentence with exactly ten words in it every time.')
        .join(' ');
    const artifact = {
        id: 'artifact_004',
        type: 'note',
 ...
 */
function example5_charOffsetTracking() {
    console.log('\n=== Example 5: Char Offset Tracking ===\n');
    const artifact = {
        id: 'artifact_005',
        type: 'note',
 ...
 */
function example6_sentenceSplitting() {
    console.log('\n=== Example 6: Sentence Splitting ===\n');
...
Follow-up scheduled in 2 weeks!`;
    const sentences = text_chunker_service_1.default.splitIntoSentences(text);
    console.log(`Original text:\n"${text}"\n`);
 ...
 */
function example7_edgeCaseEmptyText() {
    console.log('\n=== Example 7: Edge Case - Empty Text ===\n');
    const artifacts = [
        {
            id: 'artifact_006',
 ...
 */
function example8_edgeCaseVeryLongSentence() {
    console.log('\n=== Example 8: Edge Case - Very Long Sentence ===\n');
    // Create a very long sentence (400+ words)
    const longSentence = `Patient presents with a complex medical history including ${Array(400)
        .fill('word')
 ...
 */
function example9_chunkStatistics() {
    console.log('\n=== Example 9: Chunk Statistics ===\n');
    const longText = Array(100)
        .fill('This is a test sentence for chunking analysis with medical content.')
        .join(' ');
    const artifact = {
        id: 'artifact_009',
        type: 'note',
    ...
    const chunks = text_chunker_service_1.default.chunk(artifact);
    const stats = text_chunker_service_1.default.getChunkStats(chunks);
    ...
    console.log(`- Avg characters per chunk: ${stats.avg_chars_per_chunk.toFixed(1)}`);
    // Output:
    // Chunk Statistics:
    // - Total chunks: 5
 ...
 */
function example10_offsetVerification() {
    console.log('\n=== Example 10: Offset Verification ===\n');
    const artifact = {
        id: 'artifact_010',
        type: 'note',
    ...
    const chunks = text_chunker_service_1.default.chunk(artifact);
    const isValid = text_chunker_service_1.default.verifyOffsets(chunks, artifact.text);
    console.log(`Total chunks: ${chunks.length}`);
 ...
 */
function example11_realWorldMedicalNote() {
    console.log('\n=== Example 11: Real-World Medical Note ===\n');
    const artifact = {
        id: 'artifact_011',
        type: 'note',
 ...
 */
function example12_artifactTypeIntegration() {
    console.log('\n=== Example 12: Integration with Artifact Types ===\n');
    const artifacts = [
        {
            id: 'care_plan_001',
 ...
 */
function example13_metadataPreservation() {
    console.log('\n=== Example 13: Metadata Preservation ===\n');
    const artifact = {
        id: 'artifact_013',
        type: 'note',
 ...
 */
function example14_multipleChunksOverlap() {
    console.log('\n=== Example 14: Multiple Chunks from Same Artifact ===\n');
    const artifact = {
        id: 'artifact_014',
        type: 'note',
        ...
        text: Array(50)
            .fill('Patient presents for follow-up of chronic conditions including diabetes and hypertension with medication review and adjustment as needed.')
            .join(' '),
    ...
    for (let i = 0; i < chunks.length - 1; i++) {
        ...
        console.log(`  Overlap: ${chunk1.char_offsets[1] - chunk2.char_offsets[0]} chars`);
        console.log(`  Last 50 chars of chunk ${i + 1}: "...${chunk1.chunk_text.slice(-50)}"`);
        console.log(`  First 50 chars of chunk ${i + 2}: "${chunk2.chunk_text.slice(0, 50)}..."`);
        console.log();
    }
    // Output:
 ...
 */
function example15_explainTextChunker() {
    console.log('\n=== Example 15: Explain Text Chunker ===\n');
    const explanation = text_chunker_service_1.default.explain();
...
//# sourceMappingURL=text-chunker.example.js.map