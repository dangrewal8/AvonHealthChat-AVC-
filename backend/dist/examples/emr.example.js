...
exports.exampleFetchCarePlans = exampleFetchCarePlans;
exports.exampleFetchMedicationsWithFilters = exampleFetchMedicationsWithFilters;
exports.exampleFetchAllData = exampleFetchAllData;
exports.exampleCachingBehavior = exampleCachingBehavior;
exports.exampleMultiplePatients = exampleMultiplePatients;
exports.exampleErrorHandling = exampleErrorHandling;
exports.examplePagination = examplePagination;
exports.exampleExpressRoute = exampleExpressRoute;
exports.exampleCacheManagement = exampleCacheManagement;
exports.exampleBatchFetchWithRateLimit = exampleBatchFetchWithRateLimit;
const emr_service_1 = __importDefault(require("../services/emr.service"));
/**
 * Example 1: Fetch care plans for a patient
 */
async function exampleFetchCarePlans() {
    const patientId = 'patient_123';
    try {
        const result = await emr_service_1.default.fetchCarePlans(patientId);
 ...
 */
async function exampleFetchMedicationsWithFilters() {
    const patientId = 'patient_123';
    const options = {
        dateFrom: '2024-01-01',
        dateTo: '2024-12-31',
 ...
 */
async function exampleFetchAllData() {
    const patientId = 'patient_123';
    try {
...
async function exampleCachingBehavior() {
    ...
    const result1 = await emr_service_1.default.fetchCarePlans(patientId);
    console.log(`Cached: ${result1.cached}, Time: ${result1.fetchTime}ms`);
    console.log('\nSecond fetch (should hit cache):');
    const result2 = await emr_service_1.default.fetchCarePlans(patientId);
    ...
    const result3 = await emr_service_1.default.fetchCarePlans(patientId);
    console.log(`Cached: ${result3.cached}, Time: ${result3.fetchTime}ms`);
}
/**
 * Example 5: Fetch data for multiple patients in parallel
 */
async function exampleMultiplePatients() {
    const patientIds = ['patient_123', 'patient_456', 'patient_789'];
    try {
        const results = await Promise.all(patientIds.map((patientId) => emr_service_1.default.fetchAll(patientId)));
...
async function exampleErrorHandling() {
    ...
    try {
        const result = await emr_service_1.default.fetchCarePlans(invalidPatientId);
        return result;
    }
    catch (error) {
...
function exampleExpressRoute() {
    return async (req, res) => {
        ...
        try {
            const result = await emr_service_1.default.fetchAll(patient_id);
            res.json({
                success: true,
                data: {
...
async function exampleCacheManagement() {
    ...
    await emr_service_1.default.fetchCarePlans(patientId);
    await emr_service_1.default.fetchMedications(patientId);
    await emr_service_1.default.fetchNotes(patientId);
    // Check cache stats
...
async function exampleBatchFetchWithRateLimit() {
    ...
    for (let i = 0; i < patientIds.length; i += batchSize) {
        ...
        try {
            const batchResults = await Promise.allSettled(batch.map((patientId) => emr_service_1.default.fetchAll(patientId)));
...
//# sourceMappingURL=emr.example.js.map