...
exports.exampleBasicIndexing = exampleBasicIndexing;
exports.exampleProgressTracking = exampleProgressTracking;
exports.exampleBatchIndexing = exampleBatchIndexing;
exports.exampleReindexing = exampleReindexing;
exports.exampleIndexStats = exampleIndexStats;
exports.exampleErrorRecovery = exampleErrorRecovery;
...
async function initializeServices() {
    ...
    await indexing_agent_service_1.default.initialize();
...
async function exampleBasicIndexing() {
    ...
    try {
        ...
        // Index chunks
        const result = await indexing_agent_service_1.default.indexChunks(chunks);
        console.log('\n  Results:');
...
async function exampleProgressTracking() {
    ...
    try {
        ...
        const result = await indexing_agent_service_1.default.indexChunks(chunks, progressCallback);
        console.log('');
        console.log('  Results:');
        console.log(`    Chunks indexed: ${result.chunksIndexed}`);
        console.log(`    Sentences indexed: ${result.sentencesIndexed}`);
 ...
 */
async function exampleBatchIndexing() {
    ...
    try {
        ...
        const allChunks = artifacts.map((artifact, i) => ({
        ...
        const result = await indexing_agent_service_1.default.indexChunks(allChunks);
        console.log('\n  Results:');
 ...
 */
async function exampleIndexStats() {
    console.log('Example 5: Index Statistics');
    console.log('-'.repeat(80));
    try {
        console.log('  Retrieving index statistics...');
        const stats = await indexing_agent_service_1.default.getIndexStats();
        console.log('\n  Index Statistics:');
        console.log('  ─────────────────');
...
// runAllExamples();
//# sourceMappingURL=indexing-agent.example.js.map