...
exports.exampleBasicRecording = exampleBasicRecording;
exports.examplePerformanceMetrics = examplePerformanceMetrics;
exports.exampleStageBreakdown = exampleStageBreakdown;
exports.examplePercentileCalculation = examplePercentileCalculation;
exports.exampleTimeWindowFiltering = exampleTimeWindowFiltering;
exports.exampleCacheMetrics = exampleCacheMetrics;
exports.exampleCacheHitRate = exampleCacheHitRate;
exports.exampleErrorTracking = exampleErrorTracking;
exports.exampleErrorRate = exampleErrorRate;
exports.exampleSlowQueryDetection = exampleSlowQueryDetection;
exports.exampleMetricsExport = exampleMetricsExport;
exports.exampleCleanup = exampleCleanup;
exports.exampleReset = exampleReset;
exports.exampleRealWorldPipeline = exampleRealWorldPipeline;
exports.exampleExplain = exampleExplain;
exports.runAllExamples = runAllExamples;
const performance_monitor_service_1 = __importDefault(require("../services/performance-monitor.service"));
/**
 * Example 1: Basic metric recording
 */
function exampleBasicRecording() {
    console.log('Example 1: Basic Metric Recording');
    console.log('-'.repeat(80));
    // Record metrics for different stages
    performance_monitor_service_1.default.recordMetric('query_understanding', 45);
    performance_monitor_service_1.default.recordMetric('retrieval', 120);
    performance_monitor_service_1.default.recordMetric('generation', 230);
    performance_monitor_service_1.default.recordMetric('confidence_scoring', 15);
    performance_monitor_service_1.default.recordMetric('provenance_formatting', 10);
    performance_monitor_service_1.default.recordMetric('response_building', 5);
    performance_monitor_service_1.default.recordMetric('audit_logging', 8);
    performance_monitor_service_1.default.recordMetric('end_to_end', 433);
    console.log('  ✅ Recorded metrics for 8 stages');
    console.log('  Total metric count:', performance_monitor_service_1.default.getMetricCount());
    console.log();
    // Reset for next example
    performance_monitor_service_1.default.reset();
}
/**
...
function examplePerformanceMetrics() {
    ...
    latencies.forEach((latency, i) => {
        performance_monitor_service_1.default.recordMetric('end_to_end', latency);
        console.log(`    Query ${i + 1}: ${latency}ms`);
    });
    // Get metrics
    const metrics = performance_monitor_service_1.default.getMetrics();
    console.log('\n  Performance Metrics:');
 ...
 */
function exampleStageBreakdown() {
    ...
    for (let i = 0; i < 5; i++) {
        performance_monitor_service_1.default.recordMetric('query_understanding', 40 + Math.random() * 20);
        performance_monitor_service_1.default.recordMetric('retrieval', 100 + Math.random() * 50);
        performance_monitor_service_1.default.recordMetric('generation', 200 + Math.random() * 100);
        performance_monitor_service_1.default.recordMetric('confidence_scoring', 10 + Math.random() * 10);
        performance_monitor_service_1.default.recordMetric('provenance_formatting', 8 + Math.random() * 5);
        performance_monitor_service_1.default.recordMetric('response_building', 3 + Math.random() * 4);
        performance_monitor_service_1.default.recordMetric('audit_logging', 5 + Math.random() * 5);
    }
    // Get stage breakdown
    const stages = performance_monitor_service_1.default.getStageBreakdown();
 ...
 */
function examplePercentileCalculation() {
 ...
 */
async function exampleTimeWindowFiltering() {
    ...
    for (let i = 0; i < 5; i++) {
        performance_monitor_service_1.default.recordMetric('end_to_end', 150 + Math.random() * 50);
    }
    // Get all-time metrics
    const allTimeMetrics = performance_monitor_service_1.default.getMetrics();
    ...
    for (let i = 0; i < 5; i++) {
        performance_monitor_service_1.default.recordMetric('end_to_end', 180 + Math.random() * 60);
    }
    // Get metrics for different time windows
    const last5Seconds = performance_monitor_service_1.default.getMetrics(5000);
    const last1Second = performance_monitor_service_1.default.getMetrics(1000);
...
function exampleCacheMetrics() {
    ...
    cacheResults.forEach((hit, i) => {
        performance_monitor_service_1.default.recordCacheMetric(hit);
...
function exampleCacheHitRate() {
    ...
    for (let i = 0; i < 100; i++) {
        performance_monitor_service_1.default.recordCacheMetric(Math.random() < 0.8); // 80% hit rate
    }
    const hitRate1 = performance_monitor_service_1.default.getCacheHitRate();
    console.log('    Cache hit rate:', (hitRate1 * 100).toFixed(1), '%');
    // Reset
    performance_monitor_service_1.default.reset();
    console.log('\n  Scenario 2: Low cache hit rate (30%):\n');
    for (let i = 0; i < 100; i++) {
        performance_monitor_service_1.default.recordCacheMetric(Math.random() < 0.3); // 30% hit rate
    }
    const hitRate2 = performance_monitor_service_1.default.getCacheHitRate();
...
function exampleErrorTracking() {
    ...
    results.forEach((result, i) => {
        performance_monitor_service_1.default.recordMetric(result.stage, result.duration, result.success);
...
function exampleErrorRate() {
    ...
    for (let i = 0; i < 100; i++) {
        ...
        performance_monitor_service_1.default.recordMetric('end_to_end', success ? 150 + Math.random() * 50 : 0, success);
    }
    const errorRate1 = performance_monitor_service_1.default.getErrorRate();
    ...
    const errorRate2 = performance_monitor_service_1.default.getErrorRate();
 ...
 */
function exampleSlowQueryDetection() {
    ...
    const slowQueries = performance_monitor_service_1.default.getSlowQueries(300);
...
function exampleMetricsExport() {
    ...
    for (let i = 0; i < 10; i++) {
        ...
        performance_monitor_service_1.default.recordMetric('retrieval', 100 + Math.random() * 50);
        performance_monitor_service_1.default.recordMetric('generation', 200 + Math.random() * 100);
        performance_monitor_service_1.default.recordMetric('end_to_end', 350 + Math.random() * 150);
        // Some cache hits/misses
        performance_monitor_service_1.default.recordCacheMetric(Math.random() > 0.3);
    }
    // Export metrics
    const exportData = performance_monitor_service_1.default.exportMetrics();
...
function exampleCleanup() {
    ...
    console.log('    Metric count:', performance_monitor_service_1.default.getMetricCount());
...
function exampleReset() {
    ...
    for (let i = 0; i < 20; i++) {
        performance_monitor_service_1.default.recordMetric('end_to_end', 150 + Math.random() * 50);
        performance_monitor_service_1.default.recordCacheMetric(Math.random() > 0.5);
    }
    console.log('  Before reset:');
    console.log('    Metric count:', performance_monitor_service_1.default.getMetricCount());
    const beforeMetrics = performance_monitor_service_1.default.getMetrics();
    ...
    console.log('\n  After reset:');
    console.log('    Metric count:', performance_monitor_service_1.default.getMetricCount());
    const afterMetrics = performance_monitor_service_1.default.getMetrics();
 ...
 */
function exampleRealWorldPipeline() {
    ...
    for (let i = 1; i <= 10; i++) {
        ...
        Object.entries(timings).forEach(([stage, duration]) => {
            performance_monitor_service_1.default.recordMetric(stage, duration);
        });
        performance_monitor_service_1.default.recordMetric('end_to_end', endToEnd);
        // Cache behavior (40% hit rate for repeated queries)
        performance_monitor_service_1.default.recordCacheMetric(Math.random() < 0.4);
        // Occasional errors (5% error rate)
        const success = Math.random() > 0.05;
        if (!success) {
            performance_monitor_service_1.default.recordMetric('end_to_end', 0, false);
        }
    ...
    const metrics = performance_monitor_service_1.default.getMetrics();
    const stages = performance_monitor_service_1.default.getStageBreakdown();
    const slowQueries = performance_monitor_service_1.default.getSlowQueries(400);
    const cacheHitRate = performance_monitor_service_1.default.getCacheHitRate();
    const errorRate = performance_monitor_service_1.default.getErrorRate();
    console.log('\n  Performance Summary:');
    console.log('    Total queries:', metrics.total_queries);
...
function exampleExplain() {
    ...
    console.log('-'.repeat(80));
    const explanation = performance_monitor_service_1.default.explain();
    console.log('\n' + explanation.split('\n').map(line => `  ${line}`).join('\n'));
    console.log('\n  ✅ Success\n');
}
/**
...
// runAllExamples();
//# sourceMappingURL=performance-monitor.example.js.map