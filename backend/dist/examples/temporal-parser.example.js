...
exports.exampleRelativeTime = exampleRelativeTime;
exports.exampleSincePatterns = exampleSincePatterns;
exports.exampleDateRanges = exampleDateRanges;
exports.exampleSpecificDates = exampleSpecificDates;
exports.exampleThisPatterns = exampleThisPatterns;
exports.exampleAgoPatterns = exampleAgoPatterns;
exports.exampleRelativeTimeInfo = exampleRelativeTimeInfo;
exports.exampleNonTemporal = exampleNonTemporal;
exports.exampleMedicalPhrases = exampleMedicalPhrases;
exports.exampleHasTemporal = exampleHasTemporal;
exports.exampleMultipleTemporal = exampleMultipleTemporal;
exports.runAllExamples = runAllExamples;
const temporal_parser_service_1 = __importDefault(require("../services/temporal-parser.service"));
/**
 * Example 1: Relative time expressions ("last X months/weeks/days")
 */
function exampleRelativeTime() {
    ...
    queries.forEach((query, i) => {
        console.log(`\n  Query ${i + 1}: "${query}"`);
        const filter = temporal_parser_service_1.default.parseQuery(query);
        if (filter) {
...
function exampleDateRanges() {
    ...
    queries.forEach((query, i) => {
        console.log(`\n  Query ${i + 1}: "${query}"`);
        const dateRange = temporal_parser_service_1.default.extractDateRange(query);
        if (dateRange) {
 ...
 */
function exampleRelativeTimeInfo() {
    ...
    queries.forEach((query, i) => {
        console.log(`\n  Query ${i + 1}: "${query}"`);
        const relativeInfo = temporal_parser_service_1.default.parseRelativeTime(query);
        if (relativeInfo) {
 ...
 */
function exampleMedicalPhrases() {
...
function exampleHasTemporal() {
    ...
    queries.forEach(({ query, expected }, i) => {
        console.log(`  Query ${i + 1}: "${query}"`);
        const hasTemporal = temporal_parser_service_1.default.hasTemporal(query);
 ...
 */
function exampleMultipleTemporal() {
    ...
    queries.forEach((query, i) => {
        console.log(`  Query ${i + 1}: "${query}"`);
        const filters = temporal_parser_service_1.default.parseAll(query);
...
// runAllExamples();
//# sourceMappingURL=temporal-parser.example.js.map