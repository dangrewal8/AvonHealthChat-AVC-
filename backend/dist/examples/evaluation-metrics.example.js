...
exports.example1_BasicMetrics = example1_BasicMetrics;
exports.example2_MRR = example2_MRR;
exports.example3_NDCG = example3_NDCG;
exports.example4_SingleQueryEvaluation = example4_SingleQueryEvaluation;
exports.example5_MultipleQueryEvaluation = example5_MultipleQueryEvaluation;
exports.example6_ExportToJSON = example6_ExportToJSON;
exports.example7_ExportToCSV = example7_ExportToCSV;
exports.example8_SummaryReport = example8_SummaryReport;
exports.example9_EdgeCases = example9_EdgeCases;
exports.example10_PassFailCriteria = example10_PassFailCriteria;
const evaluation_metrics_1 = require("../utils/evaluation-metrics");
...
function example1_BasicMetrics() {
    console.log('\n=== Example 1: Basic Metrics Calculation ===\n');
    const metrics = (0, evaluation_metrics_1.createEvaluationMetrics)();
...
function example4_SingleQueryEvaluation() {
    ...
    const evaluation = metrics.evaluateQuery('query-001', 'What medications is the patient taking?', ['med-1', 'med-2', 'med-3', 'note-1'], ['med-1', 'med-2', 'med-4'], 'medications');
...
function example5_MultipleQueryEvaluation() {
    ...
    evaluations.push(metrics.evaluateQuery('q1', 'Patient medications', ['med-1', 'med-2', 'med-3'], ['med-1', 'med-2', 'med-3'], 'medications'));
    // Query 2: Moderate performance
    evaluations.push(metrics.evaluateQuery('q2', 'Recent lab results', ['lab-1', 'lab-2', 'note-1'], ['lab-1', 'lab-2', 'lab-3'], 'labs'));
    // Query 3: Poor performance
    evaluations.push(metrics.evaluateQuery('q3', 'Care plan details', ['note-1', 'note-2'], ['care-1', 'care-2', 'care-3'], 'care_plans'));
    // Query 4: Good performance
    evaluations.push(metrics.evaluateQuery('q4', 'Patient allergies', ['allergy-1', 'allergy-2'], ['allergy-1', 'allergy-2'], 'medications'));
    // Generate report
...
function example10_PassFailCriteria() {
    console.log('\n=== Example 10: Pass/Fail Criteria ===\n');
    // Strict criteria
    const strictMetrics = (0, evaluation_metrics_1.createEvaluationMetrics)({
        min_precision: 0.9,
        min_recall: 0.9,
        min_f1: 0.9,
        min_mrr: 0.8,
    ...
    // Lenient criteria
    const lenientMetrics = (0, evaluation_metrics_1.createEvaluationMetrics)({
        min_precision: 0.5,
        min_recall: 0.5,
        min_f1: 0.5,
        min_mrr: 0.3,
...
//# sourceMappingURL=evaluation-metrics.example.js.map