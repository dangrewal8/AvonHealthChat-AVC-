 ...
 */
export type DatasetCategory = 'medication' | 'care_plan' | 'temporal' | 'entity' | 'negative' | 'ambiguous';
/**
 * Category distribution for dataset balance
 */
export declare const CATEGORY_DISTRIBUTION: Record<DatasetCategory, number>;
/**
...
export interface DatasetEvaluationReport {
     ...
     */
    category_breakdown: Record<DatasetCategory, {
        total: number;
        passed: number;
        failed: number;
        mean_recall: number;
 ...
 */
export declare const DEFAULT_ACCEPTANCE_CRITERIA: AcceptanceCriteria;
/**
 * Category-specific acceptance criteria
 */
export declare const CATEGORY_ACCEPTANCE_CRITERIA: Record<DatasetCategory, AcceptanceCriteria>;
//# sourceMappingURL=golden-dataset.types.d.ts.map