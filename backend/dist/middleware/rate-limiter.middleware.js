...
class RateLimiter {
    ...
    cleanup() {
        ...
        for (const [key, requests] of this.requests.entries()) {
            ...
            const maxWindow = Math.max(this.DEFAULT_CONFIGS.user.windowMs, this.DEFAULT_CONFIGS.endpoint.windowMs, this.DEFAULT_CONFIGS.global.windowMs);
     ...
     */
    middleware(type = 'user', customConfig) {
        return (req, res, next) => {
            // Get configuration
            const config = {
